...
<body class="gradient">
    ...
    <header class="bg-black">
        <img src="images/logo.png" alt="" class="logo w-16">
        <ul>
    ...
    <div class="leading-normal tracking-normal text-white gradient">
        ...
        <div class="text-center">
            <video autoplay loop muted plays-inline class="back-video pointer-events-none">
                <source src="video/video.mp4" type="video/mp4">
            </video>
        </div>
        <!-- Produk Section -->
        <section id="section-produk" class="scroll-mt-15">
            <div class="container flex flex-row justify-between items-center py-48">
                <div class="w-[32%] flex flex-col space-y-12">
                    ...
                    <div class="flex items-center" data-aos="fade-right" data-aos-duration="1000">
                        <div class="w-3/5 z-10">
                            <a href="https://www.nivea.co.id/produk/nivea-men-deep-bright-oil-clear-mud-foam-89997770145680048.html" class="relative inline bg-[#2b2b2b] font-semibold text-lg py-3 px-10 rounded-lg capitalize shadow-one hover:bg-[#fff] hover:text-gray-800 group" target="_blank">
                ...
                <div class="w-[30%] flex flex-col items-center">
                    ...
                    <div class="w-full h-[440px] mt-4 hover:scale-105 transition-all">
                        <img src="images/nivea-deep.png" class="w-96 h-full-object-cover drop-shadow-one z-10" alt="Main Product">
                    </div>
                </div>
                <div class="w-[30%] flex flex-col items-end space-y-32 z-10">
                    <div class="relative w-[45%] pt-4 pb-6 px-4 leading-normal text-[#fff] bg-[#413F42] rounded-xl shadow-one z-50 hover:scale-110 transition-all">
                        <div class="absolute -top-[30px] left-0 h-11 w-[135px] transform skew-y-[150deg] rounded-tl-xl rounded-tr-3xl -z-10 bg-[#2b2b2b] shadow-two"></div>
                    ...
                    <div class="relative w-[45%] pt-4 pb-6 px-4 leading-normal text-[#fff] bg-[#413F42] rounded-xl shadow-one z-50 hover:scale-110 transition-all">
                        <div class="absolute -top-[30px] left-0 h-11 w-[135px] transform skew-y-[155deg] rounded-tl-xl rounded-tr-3xl -z-10 bg-[#2b2b2b] shadow-two"></div>
                        <div class="absolute -top-10 right-4 font-bold text-sm">03</div>
            ...
            <div class="swiper mySwiper" data-aos="fade-up">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="images/1.png" class="rounded-lg" />
                    </div>
                    <div class="swiper-slide">
                        <img src="images/2.png" class="rounded-lg" />
                    </div>
                    <div class="swiper-slide">
                        <img src="images/3.png" class="rounded-lg" />
                    </div>
                    <div class="swiper-slide">
                        <img src="images/4.png" class="rounded-lg" />
                    </div>
                </div>
        ...
        <section id="section-about" class="mx-20 py-16">
            <div class="grid grid-rows-2 grid-cols-3 gap-4 mx-10">

                <div class="card" style="background-image: url('images/ryan.png'); background-size: cover;" data-aos="fade-right">
                    <div class="card-text hover:translate-x-5 ease-in-out duration-300">
                        <h2 class="text-white font-semibold ml-11 mt-5">RYAN</h2>
                        <p class="text-white font-bold ml-11">FULLSTACK</p>
                    </div>
                </div>
                <div class="card" style="background-image: url('images/zidane.jpeg'); background-size: cover;" data-aos="fade-left">
                    <div class="card-text hover:translate-x-5 ease-in-out duration-300">
                        <h2 class="text-white font-semibold ml-11 mt-5">ZIDANE</h2>
                        <p class="text-white font-bold ml-11">FRONT END</p>
                    </div>
                </div>

                <div class="card" style="background-image: url('images/raka.jpeg'); background-size: cover;" data-aos="fade-right">
                    <div class="card-text hover:translate-x-5 ease-in-out duration-300">
                        <h2 class="text-white font-semibold ml-11 mt-5">RAKA</h2>
                        <p class="text-white font-bold ml-11">BACK END</p>
                    </div>
                </div>

                <div class="card" style="background-image: url('images/fathan.jpeg'); background-size: cover;" data-aos="fade-left">
                    <div class="card-text hover:translate-x-5 ease-in-out duration-300">
                        <h2 class="text-white font-semibold ml-11 mt-5">FATHAN</h2>
                        <p class="text-white font-bold ml-11">FRONT END</p>
                    </div>
                </div>

                <div class="card" style="background-image: url('images/radja.jpeg'); background-size: cover;" data-aos="fade-right">
                    <div class="card-text hover:translate-x-5 ease-in-out duration-300">
                        <h2 class="text-white font-semibold ml-11 mt-5">RADJA</h2>
                        <p class="text-white font-bold ml-11">BACK END</p>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap text-left lg:text-left">
                    <div class="w-full lg:w-6/12 px-4 py-5">
                        <img src="https://images-as.nivea.com/-/media/niveax/icons/logos/favicon.png" width="100px" alt="">
